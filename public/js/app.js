...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alertifyjs__ = __webpack_require__(15);
    ...
    $('.status-update-button').click(function () {
        ...
        $.post(url + '/news/update/status', requestObject).then(function (response) {
            if (response.status === true) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_alertifyjs___default.a.success(response.message);
            }
        });
    });
});
